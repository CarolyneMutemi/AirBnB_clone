...
class TestUser(unittest.TestCase):
    ...
    def test_public_class_attributes(self):
        ...
        self.first_user.password = {'IamtheOG'}
        self.assertEqual(self.first_user.__dict__['email'],
        ...
        self.assertEqual(self.first_user.__dict__['password'], {'IamtheOG'})
    ...
    def test_save(self):
        ...
        self.assertEqual(storage.all()[self.first_user_key].to_dict(),
                         self.first_user.to_dict())
    ...
    def test_to_dict(self):
        ...
        self.assertNotEqual(self.first_user.__dict__,
                            self.first_user.to_dict())
        self.assertIn('__class__', self.first_user.to_dict())
        self.assertNotIn('__class__', self.first_user.__dict__)
        self.assertIs(type(self.first_user.to_dict()['created_at']), str)
        self.assertIs(type(self.first_user.to_dict()['updated_at']), str)
